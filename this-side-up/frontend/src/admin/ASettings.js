...
function HomepageForm() {
  ...
  async function saveHomepageSettings() {
    try {
      const token = localStorage.getItem('token');
      await fetch(`https://thissideup-website.onrender.com/api/settings`, {
        method: 'POST',
...
function AdminForm() {
  ...
  const fetchAdmins = async () => {
    try {
      const token = localStorage.getItem('token');
      const res = await axios.get(`https://thissideup-website.onrender.com/api/user/admins`, {
        headers: {
  ...
  const addAdmin = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      await axios.put(
        `https://thissideup-website.onrender.com/api/user/admins/promote`,
        { email },
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const removeAdmin = async id => {
    try {
      const token = localStorage.getItem('token');
      await axios.delete(`https://thissideup-website.onrender.com/api/user/admins/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
...
function DiscountsForm() {
  ...
  const fetchDiscounts = async () => {
    try {
      const token = localStorage.getItem('token');
      const res = await axios.get(`https://thissideup-website.onrender.com/api/settings/discounts`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const saveSiteDiscount = async () => {
    try {
      const token = localStorage.getItem('token');
      await axios.post(
        `https://thissideup-website.onrender.com/api/settings/discounts`,
        {
          siteDiscount,
        },
        {
  ...
  const addDiscountCode = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      await axios.post(`https://thissideup-website.onrender.com/api/settings/discount-codes`, newCode, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const deleteCode = async code => {
    try {
      const token = localStorage.getItem('token');
      await axios.delete(`https://thissideup-website.onrender.com/api/settings/discount-codes/${code}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      fetchDiscounts();
    } catch (err) {
